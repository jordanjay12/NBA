 ...
 *
 */
function getGameProgress(date, awayTeamName, homeTeamName, awayTeamCity, homeTeamCity, playoff = false){
...
function getGameInfo(gameId, regularSeason){
    ...
    ({
        ...
        success: function (result){
            ...
            getTeamInfo(teamInfoSeason, homeURL, awayURL);
        },
        error: function(){
